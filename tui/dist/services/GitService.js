...
function installedRelativePath(skill) {
...
export async function getHistory(skill) {
...
export async function getDiff(skill, fromHash) {
    const relativePath = installedRelativePath(skill);
    if (!relativePath)
        return '';
    try {
...
export async function rollback(skill, toHash) {
    const relativePath = installedRelativePath(skill);
    if (!relativePath) {
